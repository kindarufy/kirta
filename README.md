...
# AI-платформа для анализа уязвимостей исходном коде помогающая повысить безопасность продукта
...
> SCA (Sofware Component Analysis) - это практика анализа библиотек и компонентов программного продукта (исходного кода) на наличие известных уязвимостей (CVE)
...
> SAST (Static Applcation Security Testing) - практика статического анализа исходного кода на наличие уязвимостей
