...
**Security-инструменты:** Syft, Grype, static code analysis, call map  
**AI layer:** клиент OpenRouter для AI-анализа

---

**KIRTA** — AI-платформа для анализа уязвимостей исходном коде.

Проект объединяет **SBOM**, **SCA-сканирование**, **статический анализ исходного кода**, **карта вызовов** и **AI-объяснение**, чтобы помочь команде понять не только *какая CVE найдена*, но и *есть ли признаки её достижимости в конкретном коде*.

KIRTA работает как AI-слой поверх результатов **Grype** и анализа кода: снижает шум, помогает приоритизировать исправления и переводит технический security-отчёт в понятное объяснение для security, development и product-команд.
...
8. Поддержка AI-анализа только бесплатными LLM-моделями сервиса `OpenRouter`
